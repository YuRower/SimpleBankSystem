...
public class Withdraw extends JFrame implements ActionListener{
    ...
    public Withdraw(String title)
    {
        ...
        c.add(withDraw);c.add(new JLabel(""));
        c.add(accN);c.add(tAccountNo);
        c.add(amount);c.add(tAmount);

        c.add(date);c.add(cpanel);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==bOK)
        {
            ...
            SearchInSerial scr = new SearchInSerial();
            ...
            {
                new WithdrawSerial(ts,notFound);
                new AmountInfo();
